...
#define VAR_CRYSTAL_LAKE_SEQUENCE                        0x405C // CUSTOM VARIABLE RENAMED FROM LILYCOVE_STATE. USED FOR ADMIN 2 EVENTS AT CRYSTAL LAKE/REMOVING THE GRUNTS AFTER SEQUENCE IS OVER
...
#define VAR_E4FIGHTS                                     0x40F7 // Unused Var NOW ELITE FOUR
