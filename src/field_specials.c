...
void CableCarWarp(void)
{
    if (gSpecialVar_0x8004 != 0)
        SetWarpDestination(MAP_GROUP(MAP_CABLE_CAR_ROUTE2STATION), MAP_NUM(MAP_CABLE_CAR_ROUTE2STATION), WARP_ID_NONE, 6, 4);
    else
        SetWarpDestination(MAP_GROUP(MAP_CABLE_CAR_SNOW_COT_STATION), MAP_NUM(MAP_CABLE_CAR_SNOW_COT_STATION), WARP_ID_NONE, 6, 4);
}
