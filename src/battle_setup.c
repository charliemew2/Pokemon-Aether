...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_RICKY] = REMATCH(TRAINER_RIVAL_JOHN_1Y_1, TRAINER_RIVAL_JOHN_1Y_2, TRAINER_RIVAL_JOHN_1Y_3, TRAINER_RIVAL_JOHN_1Y_4, TRAINER_RIVAL_JOHN_1Y_5, MAP_ROUTE109),
    ...
    [REMATCH_WINSTON] = REMATCH(TRAINER_YODEL, TRAINER_WINSTON_2, TRAINER_WINSTON_3, TRAINER_WINSTON_4, TRAINER_WINSTON_5, MAP_ROUTE104),
    ...
    [REMATCH_CALVIN] = REMATCH(TRAINER_SAYO_1, TRAINER_CALVIN_2, TRAINER_CALVIN_3, TRAINER_CALVIN_4, TRAINER_CALVIN_5, MAP_ROUTE102),
    ...
    [REMATCH_ROXANNE] = REMATCH(TRAINER_KRISTINEICEMOUNTAIN, TRAINER_ROXANNE_2, TRAINER_ROXANNE_3, TRAINER_ROXANNE_4, TRAINER_ROXANNE_5, MAP_RUSTBORO_CITY),
    [REMATCH_BRAWLY] = REMATCH(TRAINER_DIANCIE, TRAINER_BRAWLY_2, TRAINER_BRAWLY_3, TRAINER_BRAWLY_4, TRAINER_BRAWLY_5, MAP_DEWFORD_TOWN),
    ...
    [REMATCH_SIDNEY] = REMATCH(TRAINER_SAYO_E4, TRAINER_SAYO_E4, TRAINER_SAYO_E4, TRAINER_SAYO_E4, TRAINER_SAYO_E4, MAP_EVER_GRANDE_CITY),
