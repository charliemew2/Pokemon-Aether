...
const u8 gText_BirchInTrouble[] = _("Select a Pokemon!");
...
const u8 gText_DadsAdvice[] = _("You probably shouldn't use that\nright now...{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnElevatedToLvCap[] = _("{STR_VAR_1} was elevated to Lv. {STR_VAR_3}!");
