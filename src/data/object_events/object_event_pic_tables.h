...
const struct SpriteFrameImage gObjectEventPicTable_Sayo[] = {
    overworld_frame(gObjectEventPic_Sayo, 2, 4, 0),
    overworld_frame(gObjectEventPic_Sayo, 2, 4, 1),
    overworld_frame(gObjectEventPic_Sayo, 2, 4, 2),
    overworld_frame(gObjectEventPic_Sayo, 2, 4, 3),
    overworld_frame(gObjectEventPic_Sayo, 2, 4, 4),
    overworld_frame(gObjectEventPic_Sayo, 2, 4, 5),
    overworld_frame(gObjectEventPic_Sayo, 2, 4, 6),
...
const struct SpriteFrameImage gObjectEventPicTable_John1[] = {
    overworld_frame(gObjectEventPic_John1, 2, 4, 0),
    overworld_frame(gObjectEventPic_John1, 2, 4, 1),
    overworld_frame(gObjectEventPic_John1, 2, 4, 2),
    overworld_frame(gObjectEventPic_John1, 2, 4, 3),
    overworld_frame(gObjectEventPic_John1, 2, 4, 4),
    overworld_frame(gObjectEventPic_John1, 2, 4, 5),
    overworld_frame(gObjectEventPic_John1, 2, 4, 6),
    overworld_frame(gObjectEventPic_John1, 2, 4, 7),
    overworld_frame(gObjectEventPic_John1, 2, 4, 8),
};
