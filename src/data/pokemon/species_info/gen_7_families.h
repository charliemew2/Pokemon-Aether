...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_VIKAVOLT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_QUARK_DRIVE }, //HIDDEN ABILITY MEME FOR NARTH
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MUDBRAY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_TANGLING_HAIR, ABILITY_STAMINA },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_MUDSDALE}),
    },
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal, heldItem)\
    ...
    [SPECIES_JANGMO_O] =
    {
        ...
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_NONE, ABILITY_SOUNDPROOF },
        .bodyColor = BODY_COLOR_GRAY,
