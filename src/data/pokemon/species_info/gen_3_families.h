...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_BUDEW] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 10, SPECIES_ROSELIA}),
    },
#endif //P_GEN_4_CROSS_EVOS
    ...
    [SPECIES_ROSERADE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_GRASS),
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_NONE, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_SNORUNT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_GLALIE}
                            #if P_GEN_4_CROSS_EVOS
