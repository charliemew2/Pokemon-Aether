...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_UNNERVE, ABILITY_NONE, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_BROWN,
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_PANCHAM] =
    {
        ...
        .abilities = { ABILITY_IRON_FIST, ABILITY_NONE, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_WHITE,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 26, SPECIES_PANGORO}),
    },
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_BINACLE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_BARBARACLE}),
    },
    ...
    [SPECIES_AMAURA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 36, SPECIES_AURORUS}),
    },
